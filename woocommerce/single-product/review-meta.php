...
<?php // # BEGIN Everything ?>
	...
	<small class="woocommerce-review__awaiting-approval"><?php esc_html_e( 'Your review is awaiting approval', 'woocommerce' ); ?></small>
...
<?php } else { ?>
		...
		if ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ) {
			echo '<small class="woocommerce-review__verified verified">(' . esc_attr__( 'verified owner', 'woocommerce' ) . ')</small> ';
		}

		if ( Everything::to( 'site/comments/date_format' ) ) { ?>
			, <time class="woocommerce-review__published-date small" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php

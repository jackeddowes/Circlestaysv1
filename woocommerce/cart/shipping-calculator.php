...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<p class="small">
		<strong>
			<?php printf( '<a href="#" class="shipping-calculator-button alt">%s <i class="icon-down-open"></i></a>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>
		</strong>
	</p>
